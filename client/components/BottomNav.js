  ...
  return (
    <div className='bottomNav'>
      ...
      <div id='social'>
        <h6>Built By</h6>
        <div id='iconsLK' >
          <a href='https://www.linkedin.com/in/mikeo3d/' target="_blank">
          ...
          <a href='https://www.linkedin.com/in/yeung-lo/' target="_blank">
            <div className='personIcon'>
              <img className='linkedin' src='https://cdn0.iconfinder.com/data/icons/social-line-transparent/46/LinkedIn-line-transparent-512.png'/>
              <p><small>Lo</small></p>
            </div>
          </a>
          <a href='https://www.linkedin.com/in/diana-aguilar/' target="_blank">
            <div className='personIcon'>
              <img className='linkedin' src='https://cdn0.iconfinder.com/data/icons/social-line-transparent/46/LinkedIn-line-transparent-512.png'/>
